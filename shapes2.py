...
input_to_function = "{}.{}".format(shape, calculation)
# input_to_function = str.encode(input_to_function)
# input_to_function = eval(input_to_function)
locals()["{}.{}".format(shape, calculation)]()

# input_to_function = (eval(input_to_function))
# print(input_to_function)
